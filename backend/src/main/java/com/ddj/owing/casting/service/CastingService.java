...
public class CastingService {
    ...
    public ResponseEntity<String> generateCharacterImage(CastingRequestDto castingRequestDto) {
        ...
        Casting casting = Casting.builder()
                .name(castingRequestDto.getName())
                .age(castingRequestDto.getAge())
                .gender(castingRequestDto.getGender())
                .role(castingRequestDto.getRole())
                .detail(castingRequestDto.getDetail())
                .imageUrl(imageUrl)
                .build();
    ...
    private String createPrompt(CastingRequestDto castingRequestDto) {
        ...
        return String.format(
                ...
                castingRequestDto.getName(),
                castingRequestDto.getAge(),
                castingRequestDto.getGender(),
                castingRequestDto.getRole(),
                castingRequestDto.getDetail()
        );
    }

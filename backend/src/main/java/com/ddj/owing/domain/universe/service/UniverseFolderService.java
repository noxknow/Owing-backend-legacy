...
public class UniverseFolderService {
	...
	public ResponseEntity<UniverseFolderResponseDto> createFolder(
		UniverseFolderCreateRequestDto universeFolderCreateRequestDto) {

		UniverseFolder universeFolder = universeFolderCreateRequestDto.toEntity();
		UniverseFolderResponseDto dto = UniverseFolderResponseDto.fromEntity(
	...
	public ResponseEntity<List<UniverseFolderResponseDto>> getAllFolders(Long projectId) {

		List<UniverseFolder> universeFolders = universeFolderRepository.findByProjectId(projectId);
